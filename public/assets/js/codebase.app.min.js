...
!(function () {
                        ...
                        jQuery(
                            ...
                            .on("click.cb.helpers.core", function (e) {
                                ...
                                a
                                    ...
                                    ).toggleClass(a.data("class").toString());
                            });
                    },
                },
                {
                        ...
                        jQuery(
                            ...
                            n.addClass("js-table-checkable-enabled"),
                                jQuery("thead input:checkbox", n).on(
                                    "click.cb.helpers",
                                    function (a) {
                                        var t = jQuery(a.currentTarget).prop(
                                            "checked"
                                        );
                                        jQuery("tbody input:checkbox", n).each(
                                            function (a, n) {
                                                var o = jQuery(n);
                        ...
                        "init" === e
                            ? (a._lPage.addClass("side-trans-enabled"),
                              jQuery(window).on("resize", function () {
                                  clearTimeout(a._lResize),
                                      a._lPage.removeClass(
                                          "side-trans-enabled"
                                      ),
                                      (a._lResize = setTimeout(function () {
                                          a._lPage.addClass(
                                              "side-trans-enabled"
                                          );
                                      }, 500));
                    ...
                    value: function () {
                        ...
                        var n = {
                            ...
                            sidebar_mini_toggle: function () {
                                t._windowW > 991 &&
                                    t._lPage.toggleClass("sidebar-mini");
                            },
                            ...
                            sidebar_mini_off: function () {
                                t._windowW > 991 &&
                                    t._lPage.removeClass("sidebar-mini");
                            },
                            ...
                            header_style_inverse_toggle: function () {
                                t._lPage.hasClass("page-header-modern") ||
                                    t._lPage.toggleClass("page-header-inverse");
                            },
                            header_style_inverse_on: function () {
                                t._lPage.hasClass("page-header-modern") ||
                                    t._lPage.addClass("page-header-inverse");
                            },
                            header_style_inverse_off: function () {
                                t._lPage.hasClass("page-header-modern") ||
                                    t._lPage.removeClass("page-header-inverse");
                            },
    ...
    function s(e, a) {
        if (a && ("object" === l(a) || "function" == typeof a)) return a;
        if (void 0 !== a)
            throw new TypeError(
