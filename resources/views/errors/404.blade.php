...
<body>
    ...
    <div class="error">
      ...
      {{-- <a  href="/login" class="error__button error__button--active">LOGIN</a> --}}
      {{-- <form id="formLogout" method="post">cs --}}
        <a class="dropdown-item error__button error__button--active" action="/logout"
            onclick="event.preventDefault();
            document.getElementById('formLogout').submit();">
            <i class="si si-logout mr-5"></i> Sign Out
        </a>
        {{-- </form> --}}
      <button class="error__button">cooming soon</button>
    </div>
