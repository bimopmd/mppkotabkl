        ...
        <form class="js-validation-bootstrap" action="/dashboard/instansi/{{$instansi->id}}" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group row">
                ...
                <div class="form-material form-material-primary floating">
                    <select type="text" class="form-control" id="pegawai_id" name="pegawai_id" value="{{old('pegawai_id')}}">
                        ...
                        <option value="{{$item->id}}" {{old('pegawai_id', $instansi->pegawai_id) == $item->id ? 'selected' : null}} >{{$item->instansi_pegawai}}</option>
                        @endforeach
                    </select>
            ...
            <div class="form-group row">
                ...
                <div class="form-material">
                    ...
                    <input id="profile_instansi" type="hidden" class="form-control" id="profile_instansi" name="profile_instansi" value="{{old('profile_instansi', $instansi->profile_instansi)}}" rows="5" placeholder="....">
